							...
							<div class="card">
								<div class="card-body">
									...
									<h1 class="display-5 mt-1 mb-3">
									    <?php
									        $sql="SELECT COUNT(*) AS c FROM teach_subj WHERE sem='$sem' and branch='$branch'";
						...
						<div class="col-md-6 col-lg-3 col-xl">
							<div class="card">
								<div class="card-body">
									...
									<h1 class="display-5 mt-1 mb-3">
									    <?php
									        $sql="SELECT COUNT(*) AS c FROM routine WHERE sem='$sem' and branch='$branch'";
									        $row=mysqli_fetch_assoc(mysqli_query($conn,$sql));
									        echo $row['c'];
									    ;?>
									</h1>
							...
							<div class="card">
								<div class="card-body">
									...
									<h1 class="display-5 mt-1 mb-3">
									    <?php
									        $day=date("N");
									        $sql="SELECT COUNT(*) AS c FROM routine WHERE day='$day' AND sem='$sem' and branch='$branch'";
									        $row=mysqli_fetch_assoc(mysqli_query($conn,$sql));
									        echo $row['c'];
									    ;?>
									</h1>
